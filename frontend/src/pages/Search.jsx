...
export default function Search() {
    ...
    const hadnleShowMore = async () => {
        const numberOfPosts = posts.length
        const startIndex = numberOfPosts
        const urlParams = new URLSearchParams(location.search)
        urlParamas.set('satrtIndex', startIndex)
        const searchQuery = urlParams.toString()
        const res = await fetch(`/api/post/getposts?${searchQuery}`)
        if (!res.ok) {
            return
    ...
    return (
        ...
        <div className='flex flex-col md:flex-row'>
            <div className=' p-7 border-b md:border-right md:min-h-screen border-gray-500'>
            ...
            <div className='w-full'>
                ...
                <div className='p-7 flex flex-wrap gap-4'>
                    ...
                    {
                        showMore && <button onClick={handleShowMore} className='text-teal-500 text-lg hover:underline
                         p-7'>show more</button>
                    }
                </div>
            </div>
        </div>
